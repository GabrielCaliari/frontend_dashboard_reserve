...
describe("sanitizeHtml", () => {
  describe("Unit Tests - Specific Examples", () => {
    ...
    it("should remove inline event handlers", () => {
      expect(sanitizeHtml('<p onclick="alert()">Click</p>')).toBe(
        "<p>Click</p>",
      );
      expect(sanitizeHtml('<a href="#" onmouseover="alert()">Link</a>')).toBe(
        '<a href="#">Link</a>',
      );
    });

    it("should remove javascript: protocol from links", () => {
      expect(sanitizeHtml('<a href="javascript:alert()">Click</a>')).toBe(
        "<a>Click</a>",
      );
    });
    ...
    it("should preserve code blocks", () => {
      ...
      expect(sanitizeHtml("<pre>code block</pre>")).toBe(
        "<pre>code block</pre>",
      );
    });
...
describe("truncateHtml", () => {
  describe("Unit Tests - Specific Examples", () => {
    it("should truncate long text", () => {
      expect(truncateHtml("<p>This is a long article</p>", 10)).toBe(
        "This is a ...",
      );
    });
