...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  [ACCESS_MANAGEMENT_ERRORS.ADMIN_EMAIL_DUPLICATE]: 'An admin with this email already exists',
  [ACCESS_MANAGEMENT_ERRORS.ADMIN_SELF_DEACTIVATE]: 'You cannot deactivate your own account',
  [ACCESS_MANAGEMENT_ERRORS.ADMIN_SELF_DELETE]: 'You cannot delete your own account',
  ...
  [ACCESS_MANAGEMENT_ERRORS.TENANT_SLUG_DUPLICATE]: 'A tenant with this slug already exists',
  ...
  [ACCESS_MANAGEMENT_ERRORS.USER_EMAIL_DUPLICATE]: 'A user with this email already exists',
  ...
  [ACCESS_MANAGEMENT_ERRORS.ADMIN_ALREADY_ASSIGNED]: 'This admin is already assigned to this tenant',
  [ACCESS_MANAGEMENT_ERRORS.ADMIN_NOT_ASSIGNED]: 'This admin is not assigned to this tenant',
  [ACCESS_MANAGEMENT_ERRORS.ASSIGN_ADMIN_FAILED]: 'Failed to assign admin to tenant',
  [ACCESS_MANAGEMENT_ERRORS.REMOVE_ADMIN_FAILED]: 'Failed to remove admin from tenant',
  [ACCESS_MANAGEMENT_ERRORS.UPDATE_ROLE_FAILED]: 'Failed to update admin role',
  
  // Network and generic messages
  [ACCESS_MANAGEMENT_ERRORS.NETWORK_ERROR]: 'Network error. Please check your connection and try again.',
  [ACCESS_MANAGEMENT_ERRORS.VALIDATION_ERROR]: 'Please check your input and try again',
  [ACCESS_MANAGEMENT_ERRORS.UNAUTHORIZED]: 'You are not authorized. Please log in again.',
  [ACCESS_MANAGEMENT_ERRORS.FORBIDDEN]: 'You do not have permission to perform this action',
  [ACCESS_MANAGEMENT_ERRORS.INTERNAL_SERVER_ERROR]: 'An unexpected error occurred. Please try again later.',
};
