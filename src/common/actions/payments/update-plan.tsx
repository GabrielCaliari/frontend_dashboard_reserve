...
import type { UpdateStripePlanDto, StripePlan } from '@/src/common/@types/@payments';
...
export async function updatePlanAction(
  ...
  try {
    ...
    if (!tenantId) {
      throw new Error('Nenhum tenant selecionado. Selecione um tenant antes de atualizar um plano.');
    }
