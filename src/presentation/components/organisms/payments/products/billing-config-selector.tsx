...
import type { BillingConfiguration, BillingMode, BillingInterval } from'@/src/shared/domain/types/@billing-config';
...
export function BillingConfigSelector({
 ...
 classNames={{ trigger:'bg-default-100 border-[#2a2a3e]' }}
 >
 <SelectItem key="day">{t('intervalDay')}</SelectItem>
 <SelectItem key="month">{t('intervalMonth')}</SelectItem>
 <SelectItem key="year">{t('intervalYear')}</SelectItem>
 </Select>
 </div>
