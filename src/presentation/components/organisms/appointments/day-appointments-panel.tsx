...
import type { Appointment, EAppointmentStatus } from"@/src/shared/domain/types/@appointment";
...
export function DayAppointmentsPanel({ date, appointments, onRefresh }: DayAppointmentsPanelProps) {
 ...
 className="w-full rounded-xl border border-divider bg-default-100 hover:bg-default-100 p-3 space-y-2.5 transition-all cursor-pointer text-left group"
 >
 {/* Horário + Status */}
