...
import { useCreateLead } from"@/src/shared/hooks/leads/use-create-lead";
...
export function CreateLeadDialog({ open, onClose, collectionId }: CreateLeadDialogProps) {
 ...
 <Button size="sm" variant="flat" type="button" onPress={handleClose}>
 Cancel
 </Button>
 <Button
 size="sm"
