...
const accessModeColors: Record<
 CollectionAccessMode,"success" |"warning" |"danger"
> = {
...
export function CollectionsTable() {
 ...
 <Chip
 size="sm"
 color={accessModeColors[collection.access_mode ?? 'public']}
 variant="flat"
 >
 {accessModeLabels[collection.access_mode ?? 'public']}
 </Chip>
 </TableCell>
 <TableCell>
 ...
 {collection.access_mode === CollectionAccessMode.RESTRICTED ? (
 <DropdownItem
 key="regenerate"
