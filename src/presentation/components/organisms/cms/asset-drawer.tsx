...
function getFilePreviewIcon(mimeType: string) {
  ...
  if (mimeType.startsWith("video/"))
    return <Video className="w-16 h-16 text-violet-400" />;
...
export function AssetDrawer({
  ...
  return (
    <>
      ...
      />
      {/* Drawer panel */}
      <div className="fixed right-0 top-0 h-full w-full sm:max-w-[95vw] md:max-w-2xl z-50 bg-background border-l border-border flex flex-col overflow-hidden">
        {/* Header */}
        ...
        {!asset ? (
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="flex flex-col lg:flex-row gap-0 h-full">
              {/* Preview panel */}
              <div className="lg:w-[55%] bg-default-100 flex items-center justify-center p-4 sm:p-6 lg:p-8 min-h-[200px] sm:min-h-[280px] lg:min-h-0">
              ...
              <div className="lg:w-[45%] p-4 sm:p-5 lg:p-6 space-y-5 border-t lg:border-t-0 lg:border-l border-border">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      classNames={{
                        ...
                        inputWrapper: "bg-default-100 border border-border",
                      }}
                    />
                    <Button
                      isIconOnly
                ...
                <div>
                  <Input
                    ...
                    size="sm"
                    classNames={{
                      input: "bg-default-100 text-foreground",
                      inputWrapper:
                ...
                <div>
                  <Textarea
                    ...
                    minRows={4}
                    classNames={{
                      input: "bg-default-100 text-foreground font-mono text-xs",
                      inputWrapper:
                        "bg-default-100 border border-border hover:border-border",
                    }}
                  />
                  ...
                  {associationsOpen && (
                    <div className="mt-3">
                      <p className="text-xs text-muted-foreground text-center py-4">
                        Associations are managed from each entity editor via the
                        relations endpoints.
                      </p>
                    </div>
                  )}
      ...
      <ConfirmationDialog
        ...
        message={
          asset
            ? `${asset.filename} — ${t("deleteConfirmMessage")}`
        ...
        variant="danger"
        isLoading={
          deleteMutation.isPending || deleteCollectionMutation.isPending
        }
      />
    </>
  );
