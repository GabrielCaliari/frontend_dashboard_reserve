...
import {
  ViewModeToggle,
  type ViewMode,
} from "@/src/presentation/components/organisms/cms/editor/view-mode-toggle";
import { KbdKey } from "@/src/presentation/components/organisms/cms/editor/editor-kbd-key";
...
export function EditorToolbar({
  ...
  const openLinkPopover = React.useCallback(() => {
    ...
    if (editor?.selection) {
      ...
      savedSelectionRef.current = JSON.parse(
