...
const accessModeDescriptions: Record<CollectionAccessMode, string> = {
 ...
 [CollectionAccessMode.PRIVATE]:"Only allowed domains can submit leads (CORS protection)",
 [CollectionAccessMode.RESTRICTED]:"Requires API key authentication for submissions",
};
