...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from"@/src/presentation/components/atoms/shadcn-ui/dialog"
...
import { CreateCampaignFormData, createCampaignSchema } from"@/src/shared/schemas/create-campaign-dialog"
...
export function CreateCampaignDialog({ isOpen, onClose }: CreateCampaignDialogProps) {
 ...
 resolver: zodResolver(createCampaignSchema(t as any))
 })
