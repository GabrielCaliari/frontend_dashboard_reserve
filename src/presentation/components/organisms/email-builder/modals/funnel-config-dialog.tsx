...
export function FunnelConfigDialog({
  ...
  const [funnelType, setFunnelType] = useState<"single" | "funnel" | null>(
    null,
  );
              ...
              {!success ? (
                <div className="space-y-4">
                  ...
                  <RadioGroup
                    value={funnelType || ""}
                    onValueChange={(value) =>
                      setFunnelType(value as "single" | "funnel")
                    }
                    className="space-y-3"
                  >
                    <div className="flex items-start space-x-2 rounded-md border p-3 hover:bg-default-100 transition-colors">
                      ...
                      <div className="space-y-1.5 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {t("funnelConfig.singleBatchDesc")}
                        </p>
                      </div>
                    </div>
              ...
              {!success ? (
                <>
                  ...
                  <Button
                    ...
                    disabled={!funnelType || isSubmitting}
                  >
                    {isSubmitting
                      ? t("common.saving")
                      : funnelType === "funnel"
