...
export function AbandonedCartModal({
    ...
    <div className="space-y-6">
        ...
        {showProductsJson ? (
          ...
          <div className="space-y-3">
            {cart.products.map((product) => (
              <div
                key={product.id}
                className="flex items-center justify-between p-3 bg-default-100 rounded-lg border border-border"
              >
                <div>
      ...
      {cart.accessOrigin && (
        <div>
          ...
          {showOriginJson ? (
            <div className="bg-background text-green-400 p-4 rounded-lg text-sm font-mono overflow-x-auto border border-border">
              <pre>{JSON.stringify(cart.accessOrigin, null, 2)}</pre>
            </div>
          ) : (
    ...
    const emailSequences = [
      {
        ...
        sentAt:
          cart.emailSequence?.step1 === "sent" ? "2024-01-15 14:30" : null,
        ...
        openedAt:
          cart.emailSequence?.step1 === "sent" ? "2024-01-15 15:45" : null,
        clicked: cart.emailSequence?.step1 === "sent" ? true : false,
        clickedAt:
          cart.emailSequence?.step1 === "sent" ? "2024-01-15 16:20" : null,
        clickedLinks:
      ...
      },
      {
        ...
        sentAt:
          cart.emailSequence?.step2 === "sent" ? "2024-01-16 10:15" : null,
        ...
        openedAt:
          cart.emailSequence?.step2 === "sent" ? "2024-01-16 11:30" : null,
        ...
        providerResponse: {
          ...
          provider: "SendGrid",
          status:
            cart.emailSequence?.step2 === "sent" ? "delivered" : "pending",
          deliveredAt:
            cart.emailSequence?.step2 === "sent" ? "2024-01-16 10:16:45" : null,
        },
      },
      {
        id: 3,
        ...
        sentAt:
          cart.emailSequence?.step3 === "sent" ? "2024-01-17 16:45" : null,
        ...
        providerResponse: {
          messageId:
            cart.emailSequence?.step3 === "sent" ? "msg_3456789012" : null,
          provider: "SendGrid",
          status:
    ...
    return (
      <div className="space-y-6">
        ...
        {emailSequences.map((email) => (
          <div
            key={email.id}
            className="border border-border rounded-lg p-6 bg-default-100"
          >
  ...
  const renderSmsTab = () => (
    <div className="space-y-6">
      ...
      <div className="border border-border rounded-lg p-6 bg-default-100">
            ...
            <tbody className="bg-card divide-y divide-gray-800">
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">
                  {cart.smsStatus === "sent" ? "2024-01-15 14:30" : "---"}
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="bg-card rounded-lg w-full max-w-md border border-border">
            ...
            <div className="p-4 space-y-4">
              <textarea
                ...
                className="w-full h-32 px-3 py-2 bg-card border border-border rounded-md focus:ring-blue-500 focus:border-blue-500 text-foreground placeholder-gray-500"
              />
              <button
