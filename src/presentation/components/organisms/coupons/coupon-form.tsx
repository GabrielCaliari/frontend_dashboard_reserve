...
import { useListB2CProducts, useListB2CCategories } from"@/src/shared/hooks/b2c-products/use-b2c-products";
...
export function CouponForm({ initialData, isSubmitting, onSubmit }: CouponFormProps) {
 ...
 <p className="text-xs text-muted-foreground italic">{t("formOverridesEmpty")}</p>
 ) : (
