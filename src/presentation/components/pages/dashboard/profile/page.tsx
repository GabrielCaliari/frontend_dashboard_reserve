...
export default function ProfilePage() {
  ...
  const { data: admin, isLoading } = useAdminById({
    id: currentAdmin.id,
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  label: "Role",
                  value: <RoleBadge role={profile.role} showTooltip />,
                },
                {
                ...
                <div
                  key={label}
                  className="flex items-center gap-4 p-3 bg-content2 rounded-lg"
                >
