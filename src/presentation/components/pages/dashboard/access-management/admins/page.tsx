...
import { StatusFilterControl, type StatusFilter } from"@/src/presentation/components/organisms/access-management/shared/status-filter";
...
import type { Admin, CreateAdminDto, UpdateAdminDto, TenantAssignmentChange } from"@/src/shared/domain/types/@access-management";
import { AdminRole } from"@/src/shared/domain/types/@access-management";
import type { CreateAdminFormData, UpdateAdminFormData } from"@/src/shared/schemas/access-management/admin-schema";
...
export default function AdminListPage() {
 ...
 onConfirm: async () => {
 try {
 await restoreDeletionMutation.mutateAsync(adminId);
 setConfirmDialog((prev) => ({ ...prev, isOpen: false }));
 } catch (error) {
 // Error handled by mutation hook
 }
