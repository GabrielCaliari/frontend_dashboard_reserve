  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="inline-flex justify-center rounded-md border border-border px-2 py-2 bg-default-100 text-sm font-medium text-foreground hover:bg-default-100 focus:outline-none">
          <MoreVertical className="h-5 w-5" />
        </button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="bg-default-100 border-border">
        <DropdownMenuItem
          onClick={() => onView(lead)}
          className="text-blue-400 cursor-pointer flex items-center hover:bg-default-100"
        >
          <Eye className="mr-2 h-4 w-4" />
          <span>{t("view")}</span>
        </DropdownMenuItem>
        <DropdownMenuItem className="text-indigo-400 cursor-pointer flex items-center hover:bg-default-100">
          <Edit className="mr-2 h-4 w-4" />
          <span>{t("edit")}</span>
        </DropdownMenuItem>
        <DropdownMenuItem className="text-red-400 cursor-pointer flex items-center hover:bg-default-100">
