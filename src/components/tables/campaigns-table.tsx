...
export async function CampaignsTable() {
 ...
 <td className="px-6 py-4 whitespace-nowrap text-foreground">{campaign.totalLeads.toLocaleString()}</td>
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="flex items-center">
 <div className="w-16 bg-default-100 rounded-full h-2.5">
 <div className="bg-emerald-600 h-2.5 rounded-full" style={{ width:`${campaign.openRate}%` }}></div>
 </div>
 <span className="ml-2 text-foreground">{campaign.openRate.toFixed(2)}%</span>
 </div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="flex items-center">
 ...
 <span className="ml-2 text-foreground">{campaign.clickRate.toFixed(2)}%</span>
 </div>
 </td>
...
async function StatusBadge({ status }: { status: string }) {
 ...
 draft: { label: t("statusDraft"), color:"bg-default-100 text-foreground" },
