...
export function AbandonedCartsTable() {
  ...
  const getTypeLabel = (type: "subscription" | "one_time") => {
    return type === "subscription"
      ? t("payments.movementsPage.typeSubscription")
      : t("payments.movementsPage.typeOneTime");
  };
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <Chip
                        ...
                        variant="flat"
                        color={
                          cart.type === "subscription" ? "secondary" : "primary"
                        }
                      >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        {t(
                          `payments.movementsPage.status${cart.status.charAt(0).toUpperCase() + cart.status.slice(1)}`,
                        )}
                      </Chip>
                    </td>
                      ...
                      <div className="flex items-center gap-2">
                        {cart.stripeLink && (
                          <Button
                            ...
                            isIconOnly
                            onPress={() =>
                              window.open(cart.stripeLink!, "_blank")
                            }
