    ...
    <div className="bg-card border border-border rounded-xl p-4 space-y-3">
      <div className="flex items-start justify-between gap-2">
        <Chip
          size="sm"
          variant="flat"
          className="font-mono text-xs bg-default-100 text-foreground shrink-0"
        >
          {coupon.code}
        </Chip>
        <CouponBadgeStatus
          ...
          <thead>
            <tr className="bg-card border-b border-border">
              {COLUMNS.map((col) => (
                <th
                  key={col}
                  className="px-4 py-3 text-left text-xs text-muted-foreground uppercase tracking-wider whitespace-nowrap"
                >
                  {col}
                </th>
              ))}
              ...
              >
                <td className="px-4 py-3 whitespace-nowrap">
                  <Chip
                    size="sm"
                    variant="flat"
                    className="font-mono text-xs bg-default-100 text-foreground"
                  >
                    {coupon.code}
                  </Chip>
                </td>
