...
function CouponCard({
 ...
 <Chip size="sm" variant="flat" className="font-mono text-xs bg-default-100 text-foreground shrink-0">
 {coupon.code}
 </Chip>
 <CouponBadgeStatus
...
export function CouponTable({ coupons, isLoading }: CouponTableProps) {
 ...
 <Chip size="sm" variant="flat" className="font-mono text-xs bg-default-100 text-foreground">
 {coupon.code}
 </Chip>
 </td>
