...
>(({ className, children, side ="right", ...props }, ref) => (
 ...
 ref={ref}
 className={cn("fixed z-50 flex flex-col bg-card border-border transition ease-in-out","data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
 side ==="right"
...
const SheetHeader = ({
 ...
 <div
 className={cn("flex flex-col space-y-1.5 px-6 pt-6 pb-4 border-b border-border", className)}
 {...props}
 />
);
