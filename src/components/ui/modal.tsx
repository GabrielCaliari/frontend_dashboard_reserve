...
export const Modal = ({
  ...
  return (
    <NextUIModal
      ...
      classNames={{
        base: cn(
          "bg-content1 border border-border shadow-2xl",
          variant === "danger" && "border-danger/50 shadow-danger/20",
          variant === "warning" && "border-warning/50 shadow-warning/20",
          className,
        ),
        ...
        closeButton:
          "hover:bg-content2 active:bg-content3 transition-colors right-4 top-4",
      }}
      radius="lg"
      {...props}
    >
