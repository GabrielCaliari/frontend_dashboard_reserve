      ...
      <SheetContent className="flex h-full w-full flex-col overflow-hidden border-border bg-content1 p-0 sm:max-w-xl">
        <SheetHeader className="border-b border-border px-6 py-4 text-left">
          ...
          <SheetDescription className="text-muted-foreground">
            Secret key for:{" "}
            <span className="text-blue-400 font-semibold">{blogTitle}</span>
          </SheetDescription>
        </SheetHeader>
              ...
              <>
                <Alert className="bg-yellow-500/10 border-border">
                  ...
                  <AlertDescription className="text-yellow-400 text-sm">
                    This will immediately invalidate the current secret key. Any
                    integrations using the existing key will stop working until
                    updated.
                  </AlertDescription>
                </Alert>

                <div className="rounded-lg border border-border bg-content2 p-4 text-sm text-muted-foreground">
                  Use this only if the current key was compromised or you
                  intentionally need to rotate credentials for this blog.
                </div>
              </>
            ) : (
              <>
                <Alert className="bg-yellow-500/10 border-border">
                  <AlertTriangle className="h-4 w-4 text-yellow-500" />
                  <AlertDescription className="text-yellow-400 text-sm">
                    Save this key now. For security reasons, it won't be shown
                    again.
                  </AlertDescription>
                </Alert>
