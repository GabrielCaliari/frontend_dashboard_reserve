...
const POWER_WORDS = ["ultimate","essential","proven","exclusive","definitive","complete","powerful","incredible","remarkable","breakthrough","revolutionary","guaranteed","secret","instant","massive","epic","brilliant",
];

const POSITIVE_WORDS = ["complete","guide","best","top","easy","simple","effective","powerful","amazing","great","perfect","smart","innovative","advanced","comprehensive","expert","professional","master",
];
...
export function SeoSidebar({
 ...
 classNames={{
 input:"font-semibold",
 inputWrapper:"border-border bg-default-100/70 data-[hover=true]:border-primary/50",
 ...
 classNames={{
 trigger:"border-border bg-default-100/70 data-[hover=true]:border-primary/50",
 ...
 <Accordion
 type="multiple"
 defaultValue={["basic-seo","additional","title-readability","content-readability",
 ]}
 className="space-y-2"
 >
 {/* Basic SEO Section */}
