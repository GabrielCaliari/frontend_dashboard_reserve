            ...
            {isEditing ? (
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  onValueChange={(value) => setFormData({ ...formData, metaDescription: value })}
                  size="sm"
                  minRows={3}
                  classNames={{
                    label: "text-xs text-gray-400",
                ...
                >
                  <SelectItem key="en_us" value="en_us">EN_US</SelectItem>
                  <SelectItem key="pt_br" value="pt_br">PT_BR</SelectItem>
                  <SelectItem key="es_es" value="es_es">ES_ES</SelectItem>
                </Select>
                <Select
                  label="Author"
