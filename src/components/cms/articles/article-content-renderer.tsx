...
export function ArticleContentRenderer({
 ...
 const contentClassName = cn("[&_h1]:mt-10 [&_h1]:mb-6 [&_h1]:text-4xl [&_h1]:font-black [&_h1]:tracking-tight [&_h1]:text-foreground","[&_h2]:mt-8 [&_h2]:mb-4 [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h2]:border-b [&_h2]:border-border [&_h2]:pb-2","[&_h3]:mt-6 [&_h3]:mb-3 [&_h3]:text-2xl [&_h3]:font-semibold [&_h3]:tracking-tight [&_h3]:text-foreground",
 className,
 );
 ...
 alt={alt ??""}
 loading="lazy"
 className={cn("my-6 w-full rounded-lg border border-border bg-default-100 object-cover",
 imageClassName,
 )}
 />
 ),
 ...
 <pre
 {...props}
 className={cn("overflow-x-auto rounded-lg border border-border bg-default-100 p-4", preClassName)}
 />
 ),
 code: ({ node: _node, className: codeClassName, ...props }) => (
 <code
 {...props}
 className={cn("rounded bg-default-100 px-1.5 py-0.5", codeClassName)}
 />
 ),
 }}
 >
