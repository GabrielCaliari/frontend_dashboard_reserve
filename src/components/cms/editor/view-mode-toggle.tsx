...
export function ViewModeToggle({
 ...
 <div
 className={cn("inline-flex items-center rounded-lg border border-border bg-default-100 p-0.5 gap-0.5",
 ...
 disabled={disabled}
 className={cn("inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium transition-all duration-200",
 !isMarkdown
