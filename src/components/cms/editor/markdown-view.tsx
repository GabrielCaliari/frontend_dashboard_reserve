...
export function MarkdownView({
 ...
 const editorTextClasses ="font-mono text-sm leading-[1.7rem] whitespace-pre [tab-size:2]";
 ...
 <div
 key={i}
 className="text-[11px] leading-[1.7rem] text-muted-foreground text-right pr-3 font-mono"
 >
 {i + 1}
 </div>
 ))}
 ...
 spellCheck={false}
 wrap="off"
 className={cn("absolute inset-0 w-full h-full min-w-max pl-14 pr-4 py-4 resize-none overflow-auto bg-transparent",
 editorTextClasses,"text-foreground caret-foreground","focus:outline-none focus:ring-0","selection:bg-primary/20",
