...
function ToolbarBtn({ icon, label, isActive, onClick, shortcut, className }: ToolbarBtnProps) {
 ...
 className={cn("inline-flex items-center justify-center w-8 h-8 rounded transition-colors","text-foreground/70 hover:text-foreground hover:bg-accent",
...
function LinkInsertPopover({ editor, onClose, savedSelection }: LinkInsertPopoverProps) {
 ...
 className="flex flex-col gap-2 p-3 w-72 bg-popover border border-border rounded-lg"
...
export function EditorToolbar({
 ...
 <div className="sticky top-0 z-40 bg-content1 border-b border-border">
 {topSlot && (
 <>
 {topSlot}
 ...
 type="button"
 data-plate-focus="true"
 className={cn("inline-flex items-center gap-1 h-8 px-2 rounded text-sm font-medium transition-colors","text-foreground/70 hover:text-foreground hover:bg-accent",
 )}
 >
 ...
 !isBlockActive("h2") &&
 !isBlockActive("h3") &&
 !isBlockActive("blockquote") &&"font-medium",
 )}
 >
 Normal text
 </DropdownMenuItem>
 ...
 isMarkActive("code")) &&"bg-accent text-foreground",
 )}
 ...
 type="button"
 data-plate-focus="true"
 className={cn("inline-flex items-center gap-0.5 h-8 px-1.5 rounded transition-colors","text-foreground/70 hover:text-foreground hover:bg-accent",
 )}
 aria-label="Lists"
 >
