      ...
      >
        {showCard && (
          <div
            ref={cardRef}
            className={cn(
              "flex flex-col gap-2 p-3 w-72 rounded-lg text-sm",
...
export function H2Element({ children, ...props }: PlateElementProps) {
  ...
  return (
    <PlateElement {...props} className="relative group mt-6 mb-3">
      ...
      <h2
        id={element?.id}
        className="text-3xl font-semibold text-foreground scroll-mt-24"
      >
        {children}
      </h2>
    </PlateElement>
...
export function H3Element({ children, ...props }: PlateElementProps) {
  ...
  return (
    <PlateElement {...props} className="relative group mt-5 mb-2">
      ...
      <h3
        id={element?.id}
        className="text-2xl font-medium text-foreground/90 scroll-mt-24"
      >
        {children}
      </h3>
    </PlateElement>
...
export function ListItemElement({ children, ...props }: PlateElementProps) {
  return (
    <PlateElement
      {...props}
      as="li"
      className="text-muted-foreground leading-relaxed [&>*]:my-0"
    >
      {children}
    </PlateElement>
  );
