...
export function LinkElement(props: PlateElementProps) {
 ...
 className={cn("cursor-pointer text-primary underline underline-offset-4","hover:text-primary/80 transition-colors",
 )}
 ...
 <div
 ref={cardRef}
 className={cn("flex flex-col gap-2 p-3 w-72 rounded-lg text-sm","bg-popover border border-border",
 )}
 ...
 className={cn("h-8 px-2.5 text-sm rounded-md","border border-border bg-background text-foreground","placeholder:text-muted-foreground","focus:outline-none focus:ring-2 focus:ring-primary/40",
 )}
 />
...
export function BlockquoteElement({ children, ...props }: PlateElementProps) {
 ...
 <PlateElement
 {...props}
 className="relative group my-4 border-l-4 border-border pl-6 py-2 italic text-muted-foreground bg-default-100/30"
 >
 <DragHandle />
 {children}
 </PlateElement>
...
export function ImageElement({ children, ...props }: PlateElementProps) {
 ...
 />
 {captionText && (
 <p className="px-4 py-2 bg-default-100/50 text-sm text-muted-foreground">
 {captionText}
 </p>
 )}
 </div>
...
export function ListElement({ children, ...props }: PlateElementProps) {
 ...
 {...props}
 as={Tag}
 className={cn("my-4 space-y-1 pl-6",
