...
function SortableAssetItem({ relation, readonly, onRemove }: SortableAssetItemProps) {
 ...
 ref={setNodeRef}
 style={style}
 className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-border transition-colors"
 >
 {/* Drag Handle */}
 {!readonly && (
 <button
 ...
 {/* Thumbnail */}
 <div className="flex-shrink-0 w-16 h-16 bg-default-100 rounded-md overflow-hidden flex items-center justify-center border border-border">
 {isImage ? (
 <img
 src={asset.url}
