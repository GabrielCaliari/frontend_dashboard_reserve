...
import { useB2BGlobalFees, useUpsertB2BGlobalFees } from '@/src/common/hooks/payments/use-b2c-fees';
...
export function B2BGlobalFeesModal({ isOpen, onClose }: B2BGlobalFeesModalProps) {
