...
export function CreateProductModal({
 ...
 const billingModeMap = {'recurring_infinite':'unlimited','recurring_limited':'limited','one_time_expiring':'one_time_exp',
 } as const;
 ...
 <div className="flex flex-wrap gap-2 p-3 bg-default-100 rounded-lg border border-[#2a2a3e]">
 ...
 <div className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-default-100 border border-[#2a2a3e]">
 <div className="flex items-center gap-2">
 <Package className="w-4 h-4 text-muted-foreground" />
 <div>
 <p className="text-sm text-foreground">{t('physicalProductLabel')}</p>
 <p className="text-xs text-muted-foreground">{t('physicalProductDesc')}</p>
 </div>
 </div>
 <Switch
