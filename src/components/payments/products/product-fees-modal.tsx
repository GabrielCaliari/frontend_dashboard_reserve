...
import { useCategories, useUpdateProductFees } from '@/src/common/hooks/payments/use-b2c-fees';
...
export function ProductFeesModal({ isOpen, onClose, product }: ProductFeesModalProps) {
      ...
      <ModalContent>
        ...
        <ModalBody className="py-5 space-y-4">
          ...
          <div className="rounded-lg bg-white/[0.02] border border-white/[0.05] px-3 py-2">
            <p className="text-[11px] text-gray-600">{t('feesProductPriorityHint')}</p>
          </div>
        </ModalBody>
