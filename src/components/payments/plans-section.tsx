  ...
  return (
    <div
      className={`p-5 rounded-xl border transition-colors ${
        plan.active
          ? "bg-default-100 border-[#2a2a3e] hover:border-[#3a3a4e]"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-foreground">
            {editingPlan
              ? t("editPlan", { name: editingPlan.plan_name })
              : t("newPlanTitle")}
          </h2>
          <Button
            variant="flat"
        ...
        {editingPlan && (
          <div className="p-3 rounded-lg bg-yellow-950/30 border border-yellow-800/50">
            <p className="text-xs text-yellow-300">
              <strong>{t("immutableWarningTitle")}</strong>{" "}
              {t("immutableWarning")}
            </p>
          </div>
        )}
  ...
  return (
    <div className="space-y-6">
      ...
      {activePlans.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-14 gap-4 rounded-xl bg-default-100 border border-[#2a2a3e]">
      ...
      >
        <ModalContent>
          ...
          <ModalBody>
            ...
            <div className="mt-3 p-3 rounded-lg bg-default-100 border border-[#2a2a3e] space-y-1.5">
              <div className="flex items-center gap-2">
          ...
          <ModalBody>
            ...
            <div className="mt-3 p-3 rounded-lg bg-red-950/30 border border-red-800/50">
              <p className="text-xs text-red-300">
                <strong>{t("deleteWarningTitle")}</strong>{" "}
                {t("deleteWarningDesc")}
              </p>
            </div>
          </ModalBody>
