...
import { Calendar, Clock, CreditCard, AlertTriangle, CheckCircle, XCircle, Pause } from "lucide-react";
import { format } from "date-fns";
import { useTranslations } from "next-intl";
import type { Subscription, SubscriptionStatus } from "@/src/common/@types/@payments";
...
const STATUS_COLOR: Record<SubscriptionStatus, "success" | "warning" | "danger" | "default" | "primary"> = {
  active: "success",
  trialing: "primary",
  past_due: "warning",
  canceled: "danger",
      ...
      {subscription.cancelAtPeriodEnd && (
        <div className="flex items-center gap-2 p-3 rounded-lg bg-orange-950/30 border border-orange-800/50">
          ...
          <span className="text-sm text-orange-300">
            {t("canceledAtPeriodEnd", { date: formatDate(subscription.currentPeriodEnd) })}
          </span>
        </div>
      )}
