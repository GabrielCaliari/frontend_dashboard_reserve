...
describe("Navigation Property Tests", () => {
  ...
  describe("Property 28: Detail navigation", () => {
    it("should navigate to admin detail page with correct ID when admin record is clicked", () => {
      ...
      fc.assert(
        fc.property(adminArbitrary, (admin) => {
          ...
          expect(mockPush).toHaveBeenCalledWith(
            `/dashboard/access-management/admins/${admin.id}`,
          );
          ...
          expect(calledUrl).toMatch(
            /\/dashboard\/access-management\/admins\/\d+/,
          );
    ...
    it("should navigate to tenant detail page with correct ID when tenant record is clicked", () => {
      ...
      fc.assert(
        fc.property(tenantArbitrary, (tenant) => {
          ...
          // Verify navigation was called with correct URL
          expect(mockPush).toHaveBeenCalledWith(
            `/dashboard/access-management/tenants/${tenant.id}`,
          );
          expect(mockPush).toHaveBeenCalledTimes(1);
          ...
          expect(calledUrl).toMatch(
            /\/dashboard\/access-management\/tenants\/\d+/,
          );
    ...
    it("should navigate to user detail page with correct ID when user record is clicked", () => {
      ...
      fc.assert(
        fc.property(userArbitrary, (user) => {
          ...
          // Verify navigation was called with correct URL
          expect(mockPush).toHaveBeenCalledWith(
            `/dashboard/access-management/users/${user.id}`,
          );
          expect(mockPush).toHaveBeenCalledTimes(1);
          ...
          expect(calledUrl).toMatch(
            /\/dashboard\/access-management\/users\/\d+/,
          );
        ...
        fc.property(
          ...
          (entityType, entityId) => {
            ...
            expect(expectedUrl).toMatch(
              /\/dashboard\/access-management\/(admins|tenants|users)$/,
            );
        ...
        fc.property(
          ...
          (admins) => {
            ...
            expect(mockPush).toHaveBeenLastCalledWith(
              `/dashboard/access-management/admins/${lastAdmin.id}`,
            );
