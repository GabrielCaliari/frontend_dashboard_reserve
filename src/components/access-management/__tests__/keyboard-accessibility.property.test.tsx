...
const interactiveElementArbitrary = fc.constantFrom('button','input','select','textarea','a'
);

// Generator for keyboard keys
const keyboardKeyArbitrary = fc.constantFrom('Tab','Enter','Escape','Space','ArrowUp','ArrowDown','ArrowLeft','ArrowRight'
);
