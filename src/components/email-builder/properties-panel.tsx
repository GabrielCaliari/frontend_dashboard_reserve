...
export default function PropertiesPanel({
  ...
  const [localComponent, setLocalComponent] =
    useState<IEmailComponent>(component);
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("textDecoration", value)
                }
              >
                <SelectTrigger>
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <Input
                id="width"
                name="width"
                value={localComponent.width || "100%"}
                onChange={handleChange}
              />
            </div>
          </>
