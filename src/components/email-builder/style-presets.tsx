...
export default function StylePresets({ componentType, onApplyPreset }: StylePresetsProps) {
 ...
 width:"90%",
 padding:"15px 0",
 dividerStyles: ["border-top: 1px dashed #dddddd","border-bottom: none"],
 },
 },
 {
 id:"divider-gradient",
 ...
 width:"80%",
 padding:"15px 0",
 dividerStyles: ["background-image: linear-gradient(to right, transparent, #007bff, transparent)","border: none",
 ],
 },
 },
 ]
