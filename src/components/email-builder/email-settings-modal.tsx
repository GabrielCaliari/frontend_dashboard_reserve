          ...
          <Tabs defaultValue="general" className="mt-4">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="general">
                {t("emailBuilder.general")}
              </TabsTrigger>
              <TabsTrigger value="header">
                {t("emailBuilder.headerTab")}
              </TabsTrigger>
              <TabsTrigger value="footer">
                {t("emailBuilder.footerTab")}
              </TabsTrigger>
            </TabsList>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setLocalSettings({ ...localSettings, useHeader: checked })
                  }
                />
              </div>
                ...
                <div className="border rounded-md p-4 mt-4 relative">
                  <div className="absolute top-2 right-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setHeaderBuilderOpen(true)}
                      className="h-8 w-8"
                    >
                      <Edit size={16} />
                    </Button>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        localSettings.headerConfig.backgroundColor || "#f5f5f5",
                    }}
                  >
                    <div
                    ...
                    >
                      {localSettings.headerConfig.logo && (
                        <img
                          src={
                            localSettings.headerConfig.logo.src ||
                            "/abstract-logo.png"
                          }
                          alt={localSettings.headerConfig.logo.alt || "Logo"}
                          style={{
                            height:
                              localSettings.headerConfig.logo.height || "60px",
                            marginRight: localSettings.headerConfig.title
                              ? "15px"
                              : "0",
                          }}
                        />
                      ...
                      {localSettings.headerConfig.title && (
                        <h1
                          style={{
                            color:
                              localSettings.headerConfig.title.color ||
                              "#333333",
                            fontSize:
                              localSettings.headerConfig.title.fontSize ||
                              "24px",
                            fontFamily:
                              localSettings.headerConfig.title.fontFamily ||
                              "Arial, sans-serif",
                            margin: "0",
                          }}
                        >
                          {localSettings.headerConfig.title.text ||
                            t("emailBuilder.defaultCompany")}
                        </h1>
                      )}
                    </div>
                  </div>
            ...
            <TabsContent value="footer" className="space-y-4 mt-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setLocalSettings({ ...localSettings, useFooter: checked })
                  }
                />
              </div>
                ...
                <div className="border rounded-md p-4 mt-4 relative">
                  <div className="absolute top-2 right-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => setFooterBuilderOpen(true)}
                      className="h-8 w-8"
                    >
                      <Edit size={16} />
                    </Button>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        localSettings.footerConfig.backgroundColor || "#f5f5f5",
                    }}
                  >
                    <div
                    ...
                    >
                      {localSettings.footerConfig.copyright && (
                        <p
                          style={{
                            color:
                              localSettings.footerConfig.copyright.color ||
                              "#666666",
                            fontSize:
                              localSettings.footerConfig.copyright.fontSize ||
                              "14px",
                            margin: "0",
                          }}
                        >
                          {localSettings.footerConfig.copyright.text ||
                            t("emailBuilder.defaultCopyright", {
                              year: new Date().getFullYear(),
                            })}
                        </p>
                      )}

                      {localSettings.footerConfig.links &&
                        localSettings.footerConfig.links.items.length > 0 && (
                          <div className="flex flex-wrap justify-center gap-2 mt-2">
                            {localSettings.footerConfig.links.items.map(
                              (link, index) => (
                                <span
                                  key={index}
                                  style={{
                                    color:
                                      localSettings.footerConfig.links?.color ||
                                      "#007bff",
                                    margin: "0 5px",
                                  }}
                                >
                                  {link.text}
                                  {index <
                                    (localSettings.footerConfig.links?.items
                                      .length || 0) -
                                      1 && " |"}
                                </span>
                              ),
                      ...
                      {localSettings.footerConfig.socialLinks &&
                        localSettings.footerConfig.socialLinks.items.length >
                          0 && (
                          <div className="flex gap-3 mt-2">
                            {localSettings.footerConfig.socialLinks.items.map(
                              (socialLink) => (
                                <span
                                  key={socialLink.id}
                                  style={{
