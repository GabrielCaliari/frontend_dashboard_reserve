...
export function EmailTemplateModal({
 ...
 const inputClasses ="w-full px-3 py-2 bg-card border border-border rounded-md focus:ring-blue-500 focus:border-blue-500 text-foreground placeholder-gray-500";

 return (
 <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
 <div className="bg-card rounded-lg w-full max-w-4xl max-h-[90vh] overflow-auto border border-border">
 {/* Header */}
 ...
 className="w-full h-64 px-3 py-2 bg-card border border-border rounded-md focus:ring-blue-500 focus:border-blue-500 text-foreground placeholder-gray-500"
 />
 {errors.content && (
