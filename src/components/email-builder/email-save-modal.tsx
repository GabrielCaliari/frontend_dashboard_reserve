...
const createEmailSaveSchema = (
  ...
  z.object({
    ...
    preheader: z
      .string()
      .max(100, t("validation.preHeaderMaxLength", { max: 100 })),
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span
                className={`text-xs ${preheader.length > MAX_PREHEADER_LENGTH ? "text-red-500" : "text-muted-foreground"}`}
              >
          ...
          <DialogFooter>
            ...
            <Button type="submit">{t("emailBuilder.continue")}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
