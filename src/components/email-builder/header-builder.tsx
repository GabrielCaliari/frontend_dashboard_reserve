...
export default function HeaderBuilder({
  ...
  const handleLogoChange = (updates: Partial<HeaderConfig["logo"]>) => {
    const updatedLogo = {
      ...(config.logo || { src: "", alt: "", height: "60px" }),
      ...updates,
    };
        ...
        >
          {showLogo && config.logo && (
            <img
              ...
              style={{
                height: config.logo.height || "60px",
                marginRight: showTitle ? "15px" : "0",
              }}
            />
          )}
            ...
            <div className="space-y-3 pl-4 border-l-2 border-border">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleTitleChange({ fontSize: value })
                  }
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleTitleChange({ fontFamily: value })
                  }
                >
