...
export default function NotFound() {
 ...
 style={{
 background:"linear-gradient(135deg, hsl(270 80% 60%), hsl(220 90% 55%), hsl(270 80% 60%))",
 ...
 <Link
 href="/dashboard"
 className="inline-flex items-center gap-2.5 px-8 py-3.5 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105 hover: hover:-purple-500/25 active:scale-95"
 style={{
 background:"linear-gradient(135deg, hsl(270 80% 55%), hsl(220 90% 50%))",
 }}
 >
 <svg
