      ...
      <ModalContent>
        <ModalHeader className="flex items-center gap-2.5">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Chip
              color={STATUS_COLORS[movement.status]}
              variant="flat"
              size="sm"
            >
        ...
        <ModalBody className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-4">
              ...
              <Section
                title={t("detailProductsCount", { count: products.length })}
              >
                {products.map((prod, i) => (
                  <div
                    key={prod.id || i}
                ...
                {movement.currentPeriodStart && (
                  <Row label={t("detailLabelPeriod")}>
                    <span className="text-xs">
                      {fmt(movement.currentPeriodStart)} →{" "}
                      {fmt(movement.currentPeriodEnd)}
                    </span>
                  </Row>
                )}
              </Section>
...
export default function PaymentsSubscriptionsPage() {
  ...
  const [selectedMovement, setSelectedMovement] =
    useState<PaymentMovement | null>(null);
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          >
            ...
            <SelectItem key="trialing" value="trialing">
              {t("statusTrialing")}
            </SelectItem>
            ...
            <SelectItem key="past_due" value="past_due">
              {t("statusPastDue")}
            </SelectItem>
          </Select>
