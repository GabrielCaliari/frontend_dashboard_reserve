...
import TenantTable from "@/src/presentation/components/organisms/access-management/tenants/TenantTable";
import { TenantFormModal } from "@/src/presentation/components/organisms/access-management/tenants/TenantFormModal";
...
export default function TenantListPage() {
  ...
  const handleToggleStatus = (tenantId: string, isActive: boolean) => {
    const actionTitle = isActive
      ? t("tenants.management.deactivateConfirmTitle")
      : t("tenants.management.activateConfirmTitle");
      ...
      <ConfirmationDialog
        ...
        confirmText={
          confirmDialog.variant === "danger"
            ? t("tenants.management.confirmDelete")
            : t("tenants.management.confirmAction")
        }
        isLoading={
