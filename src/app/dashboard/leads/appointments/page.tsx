...
import { useListAppointments } from "@/src/shared/hooks/appointments/use-list-appointments";
...
import { useListBlockedPeriods } from "@/src/shared/hooks/appointments/use-blocked-periods";
          ...
          <Tab key="calendar" title={t("tabCalendar")}>
            <div className="mt-4 space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-4">
                {/* Calendar */}
                <div className="rounded-xl border border-divider bg-default-100 p-4">
                ...
                {/* Day panel */}
                <div className="rounded-xl border border-divider bg-default-100 p-4 overflow-y-auto max-h-[600px]">
