...
import { stripHtml, truncateHtml } from'@/src/common/utils/content-sanitizer';
...
export async function generateMetadata({
 ...
 const article = await fetchPublicArticleBySlug(BLOG_SECRET_KEY, params.slug);
 ...
 const ogImage = article.images.length > 0 
 ...
 images: ogImage ? [{ url: ogImage, alt: article.images[0].alt_text || article.title }] : [],
 },
 twitter: {
